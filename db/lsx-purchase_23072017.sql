...
--
-- Host: localhost
-- Generation Time: Jul 23, 2017 at 02:36 PM
...
CREATE TABLE `company` (
  ...
  `compa_name` varchar(250) NOT NULL,
  `compa_address` text NOT NULL,
  `compa_tel` varchar(20) NOT NULL,
  `compa_phone` varchar(20) NOT NULL,
  `compa_fax` varchar(20) NOT NULL,
  `compa_info` text NOT NULL,
  `compa_person_name` varchar(250) NOT NULL,
  `compa_person_tel` int(20) NOT NULL,
  `compa_createdate` datetime NOT NULL
...
INSERT INTO `company` (`compa_id`, `compa_name`, `compa_address`, `compa_tel`, `compa_phone`, `compa_fax`, `compa_info`, `compa_person_name`, `compa_person_tel`, `compa_createdate`) VALUES
...
INSERT INTO `project` (`proj_id`, `proj_name`, `proj_owner`, `compa_id`, `proj_createdate`, `proj_about`, `status`) VALUES
...
--
ALTER TABLE `company`
  MODIFY `compa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
