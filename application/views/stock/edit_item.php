...
<!--			<div class="form-group">
			...
			<div class="row">
			<div class="col-md-3">
			Size <input type="text" name="item_size" class="form-control input-width-medium" placeholder="Size" value="<?php echo array_get($data,'item_size');?>">
			</div>
			<div class="col-md-3">
			Thickness <input type="text" name="item_thickness" class="form-control input-width-medium" placeholder="Thickness" value="<?php echo array_get($data,'item_thickness');?>">
			</div>
			<div class="col-md-3">
			P.Film <select id="input19" name="item_pfilm" class="form-control input-width-medium">
			...
			<div class="col-md-3">
			AICA Finish <input type="text" name="item_aica" class="form-control input-width-medium" placeholder="AICA Finish" value="<?php echo array_get($data,'item_aica');?>">
			</div>
			</div>
			</div>
			</div>
