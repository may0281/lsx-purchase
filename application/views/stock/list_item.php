								...
								<table class="table table-striped table-bordered table-hover table-checkable datatable">
									...
									<?php  $i=1;foreach ($q as $r) { ?>
										<tr>
											...
											<input type="button" onClick="location.href='<?php echo base_url(); ?>stock/add_more_item/<?php echo $r['item_id'];?>'" class="btn btn-sm btn" value="Add more item"><?php echo nbs(5);?><input type="button" onClick="location.href='<?php echo base_url(); ?>stock/stock_item/<?php echo $r['item_id'];?>'" class="btn btn-sm btn-success" value="Imported Detail"><?php echo nbs(5);?><input type="button" onClick="location.href='<?php echo base_url(); ?>stock/update_min/<?php echo $r['item_id'];?>'" class="btn btn-sm btn-info" value="Update Min">
											</td>
										</tr>
									<?php $i++; }?>	
									</tbody>
