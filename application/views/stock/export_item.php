    ...
    <div id="content">
        <div class="container">
			...
			<div class="widget-header">
				<h4><i class="icon-reorder"></i>Please upload file</h4>
			</div>
			<div class="widget-content">
			<form class="form-horizontal row-border" method="post" action="<?php echo base_url(); ?>stock/export_item" enctype="multipart/form-data">
			...
			<div align="left"><!--<a href="<?php echo base_url(); ?>stock/temp_list/1">รายการที่ Import ค้างไว้</a>--></div><div align="right"><input class="btn btn-sm btn-primary" type="submit" value="Confirm"> <input class="btn" type="reset" value="Reset"></div>
