                                ...
                                <tr>
                                    <td class="table-col-td" width="267" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;" valign="top" align="left">
                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Purchase NO : </strong> <?php echo $purq_code; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Project : : </strong> <?php echo $project_name; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> <?php echo strtoupper($action); ?> By : </strong> <?php echo $action_by; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> <?php echo strtoupper($action); ?> Date : </strong> <?php echo date('Y-m-d H:i:s'); ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Request date : </strong> <?php echo $purq_require_start . ' - '.  $purq_require_end ?>
                                        </p>

                                        <br>
                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Project owner name  : </strong> <?php echo $proj_owner_name; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Project contacts  : </strong> <?php echo $proj_contacts; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Project mobile  : </strong> <?php echo $proj_mobile; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Project Email  : </strong> <?php echo $proj_email; ?>
                                        </p>

                                        <br>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Designer owner name  : </strong> <?php echo $designer_name; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Designer contacts  : </strong> <?php echo $designer_contacts; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Designer mobile  : </strong> <?php echo $designer_mobile; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Designer Email  : </strong> <?php echo $designer_email; ?>
                                        </p>

                                        <br>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Contractor name  : </strong> <?php echo $contractor_name; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Contractor contacts  : </strong> <?php echo $contractor_contacts; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Contractor mobile  : </strong> <?php echo $contractor_mobile; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Contractor Email  : </strong> <?php echo $contractor_email; ?>
                                        </p>

                                        <br>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Marketing account  : </strong> <?php echo $mkt_account; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Marketing mobile  : </strong> <?php echo $mkt_mobile; ?>
                                        </p>

                                        <br>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Sale account  : </strong> <?php echo $sale_account; ?>
                                        </p>

                                        <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
                                            <strong> Sale mobile  : </strong> <?php echo $sale_mobile; ?>
                                        </p>
                                ...
                                <tr>
                                    <td class="table-col-td" width="267" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;" valign="top" align="left">
                                        ...
                                        <table class="table-space" height="6" style="height: 6px; font-size: 0px; line-height: 0; width: 267px; background-color: #ffffff;" width="267" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0">
                                            <tbody>
                                                <tr>
                                                    <td class="table-space-td" valign="middle" height="6" style="height: 6px; width: 267px; background-color: #ffffff;" width="267" bgcolor="#FFFFFF" align="left">&nbsp;
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                ...
                                                <tr>
                                                    <td width="100%" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding: 19px; border: 1px solid #e3e3e3; background-color: #f5f5f5;" valign="top" align="left">
                                                        ...
                                                        <table class="table-space" height="10" style="height: 10px; font-size: 0px; line-height: 0; width: 100px; background-color: transparent;" width="100" bgcolor="transparent" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="table-space-td" valign="middle" height="10" style="height: 10px; width: 100px; background-color: transparent;" width="100" bgcolor="transparent" align="left">&nbsp;
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
